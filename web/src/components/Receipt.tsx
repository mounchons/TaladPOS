...
// window.print(), no receipt-printer integration, no VAT line). Sized and set
// like a till slip rather than an app card, so what's on screen is what comes
// out of the printer.
export function Receipt({ sale }: { sale: Sale }) {
  return (
    <div className="mx-auto max-w-[22rem]">
      <div className="mb-4 flex justify-end print:hidden">
        <Button label="พิมพ์ใบเสร็จ" icon="pi pi-print" onClick={() => window.print()} pt={secondaryButtonPT} />
      </div>

      <article className="border border-steel-200 bg-white px-6 py-7 text-sm print:border-0 print:px-0">
